...
Due to the removal of the js script engine from Java 15 was released, the only (modern) way was to use GraalVM JDK instead of a Stock JDK.
...
I got it working on Spigot 1.20 and later with stock JDK 21, but the build system is kinda messy.
